...
- The Claude arms ran: the transcript shows subagent spawns of `fable-judgment` and `opus-xhigh`, and no Codex arm produced output, since `codex` is not on PATH for the run.
