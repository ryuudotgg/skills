---
name: codex-sol
description: Wrapper that runs a brief through gpt-5.6-sol via the Codex CLI, read-only. Use for hard unsupervised work: complex reasoning, intricate analysis, long-context investigation across a large codebase, and plan validation.
model: sonnet
effort: low
tools: Bash, Read
---
