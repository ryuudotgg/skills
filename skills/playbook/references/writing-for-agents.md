...
Vendored from [Matt Pocock's skills](https://github.com/mattpocock/skills),
MIT licensed, Copyright (c) 2026 Matt Pocock. Two edits only: merged with its
SKILL-MECHANICS companion, and frontmatter dropped since this is a reference
rather than a skill. The prose is otherwise unchanged.

Read this when writing or editing a SKILL.md, an AGENTS.md, a CLAUDE.md, or any
...
When the document you're writing is a skill, read the Skill mechanics section below for frontmatter, invocation choice, and router skills.
...
The skill-specific branch of this reference: what changes when the document is a skill (frontmatter, the invocation choice, and router skills). Everything else about writing it is the universal reference above.
