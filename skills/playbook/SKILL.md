...
- Before you hand work back → the **no-comments** skill (`/no-comments`), then the four-line style check: no comments that restate the code, no em dashes or en dashes or hyphen-as-dash, no AI-sounding copy, no wall of statements (one blank line between steps in a function body).
